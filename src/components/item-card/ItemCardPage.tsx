  ...
  return (
    <div className={c.page_body} >
      ...
      <div className={c.specs_wrapper} >
        <b>Характеристики:</b>
        <ul>
          <li>Диафрагма: F2.1</li>
          <li>Разрешение: 1920x1080</li>
          <li>Дополнительная память: Карта Micro SD (объемом до 32 ГБ)</li>
          <li>Рабочая температура: -10 ℃一40 ℃</li>
          <li>Беспроводное подключение: Wi-Fi IEEE 802.11b/g/n, 2,4 ГГц</li>
          <li>Масса нетто: 254 г</li>
          <li>Размеры: 108×75×75 мм</li>
          <li>Вход питания: 5 В/2 А</li>
          <li>Угол обзора: 110°</li>
          <li>Совместимость: Android 4.4, iOS 9.0 и более поздними версиями.</li>
        </ul>
      </div>
